...
consumo = float(input("Digite o consume médio mensal de dados em GB: "))
...
def recomendar_plano(consumo):
    if consumo >= 1 and consumo <= 10:
        ...
        return "Opção inválida. Verifique o valor de dados."
...
#     menu = """\n
#     ================ MENU ================
#     [e]\tPlano Essencial - consumo médio de até 10 GB
#     [p]\tPlano Prata - consumo médio acima de 10 GB até 20 GB.
#     [pm] Plano Premium - consumo médio acima de 20 GB.
#     [q]\tSair
#     => """
